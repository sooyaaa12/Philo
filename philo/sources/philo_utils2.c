...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/19 16:12:47 by songevor          #+#    #+#             */
/*   Updated: 2025/02/19 16:12:47 by songevor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	allocate_resources(t_tableStatus *table,
	t_guest **guests, pthread_t **guest_threads)
{
...
void	cleanup_dinner(t_tableStatus *table,
		t_guest *guests, pthread_t *threads)
{
	int	i;
