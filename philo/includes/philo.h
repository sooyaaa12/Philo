...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/19 15:49:15 by songevor          #+#    #+#             */
/*   Updated: 2025/02/19 17:20:50 by songevor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_status(t_tableStatus *table,
				int guest_id, const char *action);
...
void		cleanup_dinner(t_tableStatus *table, t_guest *guests,
				pthread_t *threads);
int			handle_argument(int argc, char **argv, t_tableStatus table);
int			kanach_kov(t_tableStatus **table,
				t_guest **guests, int found_death);
